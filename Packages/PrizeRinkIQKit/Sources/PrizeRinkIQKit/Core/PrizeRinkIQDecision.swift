...
public struct PrizeRinkIQProbePayload: Codable, Equatable, Sendable {
...
public struct PrizeRinkIQLaunchPayload: Codable, Equatable, Sendable {
...
public struct PrizeRinkIQLaunchDecision: Decodable, Equatable, Sendable {
...
private extension KeyedDecodingContainer where Key == PrizeRinkIQLaunchDecision.CodingKeys {
